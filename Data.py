...
df_before = pd.read_csv(r"C:\Users\Lenovo\Desktop\final_project\New folder\Sourse\modified_train_subset.csv")
st.write(df_before)
...
df_after = pd.read_csv(r"C:\Users\Lenovo\Desktop\final_project\New folder\Sourse\cleaned_data.csv")
st.write(df_after)
